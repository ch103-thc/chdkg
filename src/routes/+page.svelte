<script>
    const cards = [
        ...
        {
            title: "Logitech MX Anywhere 3S Wireless Mouse",
            label: "Order a Logitech MX Anywhere 3S",
            image: "/files/logitech-mx-anywhere-3S-wireless-mouse.png",
            link: "/logitech-mx-anywhere-3S-wireless-mouse",
        },
    ];
</script>
