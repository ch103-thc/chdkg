<script>
	...
	const product = $state({
		...
		originalPrice: 60,
		features: ['Bluetooth', 'Long-Lasting Battery', 'Multi-device Pairing'],
		includes: [
	...
	let productInfoSections = $state([
		{
			title: 'Specs & Details',
			intro:
				'Take your gameplay to the next level with the Razer Basilisk X Hyperspeed – a high-performance, wireless gaming mouse engineered for speed, precision, and long-lasting power, all in a lightweight design.',
	...
	<section class="section">
		<div class="container">
			...
			<section class="right-content">
				...
				<a
					href="https://www.carousell.sg/p/razer-basilisk-x-hyperspeed-lightweight-gaming-mouse-1406676529/?t-id=S6VWdRlPLF_1771337267496&t-referrer_browse_type=seller&t-referrer_page_type=profile&t-referrer_request_id=Ys1ktrVbU7EkMR7D&t-tap_index=8"
					target="_blank"
				>
