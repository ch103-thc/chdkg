<script>
	...
	const product = $state({
		...
		includes: ['1x Logitech M240 Silent Bluetooth Mouse', '1x AA battery (pre-installed)'],
		brand: 'GamaKay',
		condition: 'New'
	});
	...
	let productInfoSections = $state([
		{
			title: 'Specs & Details',
			intro:
				"Experience seamless productivity and comfort with this advanced Bluetooth mouse. Whether you're working from home, in the office, or on the go, this mouse delivers the perfect balance of performance and convenience—designed to keep up with your busy lifestyle while maintaining the quiet focus you need.",
	...
	<section class="section">
		<div class="container">
			...
			<section class="right-content">
				...
				<a
					href="https://www.carousell.sg/p/logitech-m240-silent-bluetooth-wireless-mouse-1407231009/?t-id=S6VWdRlPLF_1771337267496&t-referrer_browse_type=seller&t-referrer_page_type=profile&t-referrer_request_id=pZMEFo1cp6UeR3qg&t-tap_index=7"
					target="_blank"
				>
