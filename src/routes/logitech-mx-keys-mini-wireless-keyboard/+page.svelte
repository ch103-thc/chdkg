<script>
    ...
    const product = $state({
        ...
        description: [
            "Perfect Stroke Typing - You’ll enjoy a satisfying, fluid typing experience with low-profile scissor switches that feel stable, precise, and quiet with every press.",
            "Smart Backlighting - The keyboard lights up the moment your hands get close, and automatically adjusts to your environment – perfect for late-night work or low-light settings.",
            "Switch Between Devices Instantly - Need to reply on your laptop, tablet, or even phone? You can pair up to 3 devices via Bluetooth and switch between them effortlessly with just one tap.",
            "Compact, Space-Saving Design -  You’ll have more room for your mouse and maintain a better ergonomic posture – ideal if you’re working from a small desk or on the go.",
            "Smart Function Keys - Use built-in shortcuts for emojis, voice dictation, and mic mute – it’s all about helping you get things done faster.",
            "USB-C Rechargeable - You’ll only need to charge it once every 10 days (with backlight), or up to 5 months if you turn the backlight off.",
        ...
        includes: [
            "1x Logitech MX Keys Mini Wireless Keyboard",
    ...
    let productInfoSections = $state([
        {
            title: "Specs & Details",
            intro: "Take your workflow to the next level with the Logitech MX Keys Mini – a minimalist, wireless keyboard designed to bring you precision, comfort, and smarter control, all in a compact form factor.",
    ...
    const mediaItems = $state([
        { type: "image", src: "/files/keyboard1.jpg", alt: "View 1" },
        { type: "image", src: "/files/keyboard2.jpg", alt: "View 2" },
        { type: "image", src: "/files/keyboard3.jpg", alt: "View 3" },
    ]);
